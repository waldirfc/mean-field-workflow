...
Nplaces = 8 + 1		#number of places of the petri net (considering resources) + 1
...
#----- COMMAND DSPN -----
cmdTransient = 'sudo /home/edisone/Documents/research/GreatSPN/DSPN-Tool-Release -load /home/edisone/Documents/research/GreatSPN/nets/MacroscopicTests/macroscopic.PNPRO.solution/GSPND1 -epsilon 1.0E-7 -on-the-fly -i -i-power -rpar AR1 4.0 -rpar BR1 2.0 -mpar I 1 -mpar NR1 2 -rpar r 500.0 -t 2 -all-measures'
cmdSteady = 'sudo /home/edisone/Documents/research/GreatSPN/DSPN-Tool-Release -load /home/edisone/Documents/research/GreatSPN/nets/MacroscopicTests/macroscopic.PNPRO.solution/GSPND1 -epsilon 1.0E-7 -on-the-fly -i -i-power -rpar AR1 4.0 -rpar BR1 2.0 -mpar I 1 -mpar NR1 2 -rpar r 500.0 -s -all-measures'
...
plt.xlabel('tempo')
plt.ylabel('fichas')
plt.legend(['P0', 'P1', 'P2', 'P3', 'P4', 'P5', 'P6', 'R1'])
